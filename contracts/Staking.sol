...
contract Staking is Ownable, Initializable, ReentrancyGuard {
    ...
    */
    function stake(uint256 _time, uint256 _amount) external nonReentrant {
        ...
        require(_amount != 0, "Stake: Null amount!");
        require(_time != 0, "Stake: Null time!");
        require(rewardPercent[_time] != 0, "Stake: Time not specified.");
    ...
    */
    function claim(uint256 _txNo) external nonReentrant {
        ...
        require(
            ...
            "Stake: Rewards already claimed."
        );
        require(
            block.timestamp > stakes.stakingPerTx[_txNo].lockedUntil,
            "Stake: Stake period is not over."
        );
    ...
    */
    ...
    function setRewardPercent(uint256 _time, uint256 _percentInBP)
        ...
        onlyOwner
    {
        require(_percentInBP > 0 && _percentInBP <= 2000, "Stake: Not in Range");
